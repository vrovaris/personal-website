...
~~**Q11 — Enable Cloudflare Access on preview deploys before Phase 2 starts.**~~ Answered by D60 — Access is enabled and confirmed working. Original text: *(raised during P1-01; Vitor asked to be reminded)*
...
~~**Q16 — Write the clean-room parser in Rust rather than C?**~~ Answered by D59 — C, confirming D12; the spike succeeding put Emscripten in the project regardless. Original text: *(raised by Vitor during P2-01; decide before P4-01, not now)*
...
~~**Q17 — LGPL-2.1 obligations for shipping libseccomp as WASM.**~~ Answered by D58 — the obligations are taken on and the module ships. Original text: *(raised during P3-03; blocks shipping the module, not building it)*
